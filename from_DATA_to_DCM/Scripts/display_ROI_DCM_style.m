...
roi_folder = fullfile(scriptDir, '..', 'roisTozzi_K'); %or roisTozzi
...
% Load reference image for context (use single_subj_T1)
...
scatter3(roi_centers(:,1), roi_centers(:,2), roi_centers(:,3), ...
    100, 'r', 'filled');
%comment out the next two line to remove the labels - better for many ROIs
