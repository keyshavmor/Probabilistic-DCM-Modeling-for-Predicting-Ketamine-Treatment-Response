...
% Define search terms for region groups <> determines what ROIs to combine
region_keywords = {'Tha', 'BG*_l', 'BG*_r', 'Amy*left', 'Amy*right', 'Hipp*left','Hipp*right'}; 
