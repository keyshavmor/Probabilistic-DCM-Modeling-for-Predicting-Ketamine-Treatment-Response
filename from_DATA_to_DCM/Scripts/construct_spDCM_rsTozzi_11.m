function construct_spDCM_rsTozzi_11(dataDir)
...
voiDir = fullfile(firstlevelDir, 'VOI_rsTozzi_11'); % Directory containing VOI data (.mat files)
...
%change this when constructing other DCMs
...
% Basic DCM setup
DCM.name = 'spDCM_rsTozzi_11'; % Name for the saved file
...
DCM.a = ones(num_regions, num_regions);         % fully connected
