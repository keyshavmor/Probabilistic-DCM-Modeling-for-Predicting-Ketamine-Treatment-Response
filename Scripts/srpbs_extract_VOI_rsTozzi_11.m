function srpbs_extract_VOI_rsTozzi_11(dataDir)
...
% Modified: Leon Schönleber, - May 2025
%
...
%new_files = dir(fullfile(parcelDir, 'MyParcelPrefix*.nii'));
%ROI_names(end+1:end+numel(new_files)) = new_files;
